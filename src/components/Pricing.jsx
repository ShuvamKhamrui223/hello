          ...
          <div
            ...
            className={`${
              plan.planName == pricingContent.planToHighlight
                ...
                : " h-[35rem] rounded-2xl outline outline-2 outline-slate-800/25 dark:outline-slate-200/25"
          ...
          >
            <h3
              className={`text-[2rem]  ${
                plan.planName == pricingContent?.planToHighlight
                  ? "text-white/95"
                  : "text-black_secondary dark:text-white/70"
            ...
            <div
              className={`price pb-4 text-[4rem] ${
                plan.planName == pricingContent?.planToHighlight
                  ? "text-white"
                  : "text-black_primary dark:text-white/90"
              } font-bold`}
            >
              <span>$</span>
              {plan.planPrice}
                ...
                >
                  ...
                  <p
                    className={`capitalize ${
                      plan.planName == pricingContent?.planToHighlight
                        ? "text-white/95"
                        : "text-black_secondary dark:text-white/60"
            ...
            <Button
              className={`font-bold ${
                plan.planName == pricingContent?.planToHighlight
                  ? "text-white/95 bg-slate-100 dark:bg-black_primary"
