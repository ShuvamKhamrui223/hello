    ...
    <section className="min-h-[65vh] flex items-center">
      <div className="container flex lg:flex-row flex-col-reverse items-center">
        <div className="text_container flex gap-8 flex-col items-center md:items-start">
          <h1 className="text-7xl text-black_primary dark:text-white font-bold md:text-8xl capitalize max-w-[15ch] text-center md:text-left leading-[1.2] md:leading-[1.25]">
            its's the{" "}
          ...
          <p className="max-w-[40ch] text-black_secondary  md:max-w-[45ch] text-2xl text-center md:text-left">
