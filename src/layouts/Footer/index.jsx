...
const Footer = () => {
  return (
    <footer className="min-h-[40vh] dark:bg-black/90 flex flex-col items-center px-8 py-10 md:px-[3%] lg:px-[7%]">
      <div className="container w-full flex flex-col gap-24 items-center">
        <div className="row_1 w-full grid gap-8 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="col ">
            <h4 className="text-2xl dark:text-white first-letter:uppercase mb-4">
          ...
          <div className="col ">
            <h3 className="text-2xl text-black_primary dark:text-black_secondary/70 capitalize mb-4">
          ...
          <div className="col">
            <h3 className="text-2xl text-black_primary dark:text-black_secondary/70 capitalize mb-2">
        ...
        <div className="row_2 w-full border-t-2 pt-8 flex items-center justify-between flex-col-reverse gap-y-6 sm:flex-row">
          ...
          <div className="col flex gap-6">
            <img
              src={metaIcon}
              className="size-12 dark:invert cursor-pointer opacity-50 hover:opacity-100 "
              alt="meta"
            />
            <img
              src={facebookIcon}
            ...
            <img
              src={instagramIcon}
              className="size-12 invert dark:invert-0 cursor-pointer opacity-50 hover:opacity-100 "
              alt="instagram"
            />
          </div>
        </div>
